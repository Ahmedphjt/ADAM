...
{
    public partial class webDepartmentReport : System.Web.UI.Page
    {
        public int pageid = 21;
        ...
        protected void btnShowReport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            myReportDocument.Load(Server.MapPath("~/MainReport/Reports/rptDepartment.rpt"));
