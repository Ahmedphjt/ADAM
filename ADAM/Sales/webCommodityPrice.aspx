<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webCommodityPrice.aspx.cs" Inherits="ADAM.Sales.webCommodityPrice" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" CssClass="lblPageName" runat="server" Text="شاشة تسعير بضاعة" Font-Size="X-Large" Font-Underline="True"></asp:Label></h1>
    <table class="menu">
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:HiddenField ID="hfId" Value="0" runat="server"></asp:HiddenField>
                 <asp:HiddenField ID="hfOrderValue" Value="9" runat="server"></asp:HiddenField>
            </td>
            <td>&nbsp;</td>
