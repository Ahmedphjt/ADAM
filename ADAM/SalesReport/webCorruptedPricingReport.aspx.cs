...
{
    public partial class webCorruptedPricingReport : System.Web.UI.Page
    {
        public int pageid = 106;
        ...
        private void ShowReport()
        {
            ...
            if (ddlENo.SelectedValue == "0")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptCorruptedPricing.rpt"));
            else if(ddlENo.SelectedValue == "1")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptCorruptedPricingWithoutNo.rpt"));
            else if (ddlENo.SelectedValue == "2")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptCorruptedPricingShow.rpt"));
            ...
            myReportDocument.SetParameterValue("@OrderType", 10);
