<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webUpdateRefluxOrederData.aspx.cs" Inherits="ADAM.StoreData.webUpdateRefluxOrederData" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageData" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:SqlDataSource ID="dbRefluxDetailsData" runat="server" ConnectionString="<%$ ConnectionStrings:ADAMConnectionString %>" SelectCommand="SELECT Items.Code, Items.Name, ItemColor.ColorName, RefluxDetailsData.RefluxQty, RefluxDetailsData.RefluxFreeQty, ItemUnit.Name AS ItemUnitName, RefluxDetailsData.RefluxHeaderId, RefluxDetailsData.Id AS RefluxDetailsDataId, RefluxDetailsData.Status FROM RefluxDetailsData INNER JOIN Items ON RefluxDetailsData.ItemId = Items.Id INNER JOIN ItemColor ON RefluxDetailsData.ItemColorId = ItemColor.Id INNER JOIN ItemUnit ON Items.ItemunitId = ItemUnit.Id WHERE (RefluxDetailsData.RefluxHeaderId = @RefluxHeaderId) AND (RefluxDetailsData.Status = 0)">
                    <SelectParameters>
