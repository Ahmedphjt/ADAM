...
{
    public partial class webProductionLineItemReport : System.Web.UI.Page
    {
        public int pageid = 66;
        ...
        private void ShowReport()
        {
            ...
            myReportDocument.Load(Server.MapPath("~/MainReport/Reports/rptIProudctionLineItems.rpt"));
            ...
            myReportDocument.SetParameterValue("@ProductionLineId", long.Parse(ddlProdictionLine.SelectedValue));
            myReportDocument.SetParameterValue("@ItemId", 0);
