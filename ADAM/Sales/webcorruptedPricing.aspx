<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webcorruptedPricing.aspx.cs" Inherits="ADAM.Sales.webcorruptedPricing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" CssClass="lblPageName" runat="server" Text="شاشة تسعير صرف تالف" Font-Size="X-Large" Font-Underline="True"></asp:Label></h1>
    <table class="menu">
        <tr>
            <td>
    ...
    <table>
        <tr>
            ...
            <td>
                ...
                <asp:HiddenField ID="hfOrderValue" Value="10" runat="server"></asp:HiddenField>
            </td>
            <td>
