...
{
    public partial class webAskedOrderReport : System.Web.UI.Page
    {
        public int pageid = 108;
        ...
        private void ShowReport()
        {
            ...
            if (ddlENo.SelectedValue == "0")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptAskedOrderPricing.rpt"));
            else if(ddlENo.SelectedValue == "1")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptAskedOrderPricingWithoutNo.rpt"));
            else if (ddlENo.SelectedValue == "2")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptAskedOrderPricingShow.rpt"));
            ...
            myReportDocument.SetParameterValue("@OrderType", 12);
