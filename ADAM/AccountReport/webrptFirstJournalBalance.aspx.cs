...
{
    public partial class webrptFirstJournalBalance : System.Web.UI.Page
    {
        public int pageid = 132;
        ...
        protected void btnShowReport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            myReportDocument.Load(Server.MapPath("~/AccountReport/Report/rptFirstJournalBalance.rpt"));
