...
{
    public partial class webrptCashExpense : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var Rows = from a in db.DocumentHeaders where a.DocNo == long.Parse(txtDocumentCode.Text) && a.DocType == 1 select a;
            ...
            if (Rows.Count() > 0)
            {
                ADAM.DataBase.DocumentHeader dr = db.DocumentHeaders.Single(a => a.DocNo == long.Parse(txtDocumentCode.Text) && a.DocType == 1);
                ShowReport(dr.Id);
            }
            else
            {
        ...
        private void ShowReport(long DocId)
        {
            ...
            myReportDocument.Load(Server.MapPath("~/AccountReport/Report/rptCashExense.rpt"));
            ...
            myReportDocument.SetParameterValue("@DocType", 1);
