...
{
    public partial class webExchangeRequestReport : System.Web.UI.Page
    {
        public int pageid = 73;
        ...
        private void ShowReport()
        {
            try
            {
                ...
                myReportDocument.Load(Server.MapPath("~/StoreReport/Report/rptExchangeRequestReport.rpt"));
