...
{
    public partial class webSupplierReport : System.Web.UI.Page
    {
        public int pageid = 27;
        ...
        private void ShowReport()
        {
            ...
            if (rdoNormalSupplier.Checked)
                myReportDocument.Load(Server.MapPath("~/MainReport/Reports/rptNormalSupplier.rpt"));
            else if (rdoSpecSupplier.Checked)
                myReportDocument.Load(Server.MapPath("~/MainReport/Reports/rptSpecSupplier.rpt"));
