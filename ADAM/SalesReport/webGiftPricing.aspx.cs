...
{
    public partial class webGiftPricing : System.Web.UI.Page
    {
        public int pageid = 107;
        ...
        private void ShowReport()
        {
            ...
            if (ddlENo.SelectedValue == "0")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptGiftsPricing.rpt"));
            else if (ddlENo.SelectedValue == "1")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptGiftsPricingWithoutNo.rpt"));
            else if (ddlENo.SelectedValue == "2")
                myReportDocument.Load(Server.MapPath("~/SalesReport/Reports/rptGiftsPricingShow.rpt"));
            ...
            myReportDocument.SetParameterValue("@OrderType", 11);
