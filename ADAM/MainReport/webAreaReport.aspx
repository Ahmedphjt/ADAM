<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webAreaReport.aspx.cs" Inherits="ADAM.MainReport.webAreaReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" Text="تقرير المناطقة" CssClass="lblPageName" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageData" runat="server">
    <div style="position: relative; padding-right: 50px">
        <table class="table">
            ...
            <tr>
                <td style="text-align: center">
                    <asp:Label ID="Label2" runat="server" Text="المدينة" CssClass="lbl"></asp:Label></td>
                <td>
                    <asp:DropDownList ID="ddlGovernorate" runat="server" CssClass="txt" DataSourceID="dbGovernorate" DataTextField="GovernorateName" DataValueField="Id" Width="150px"></asp:DropDownList></td>
                <td>
                    <asp:SqlDataSource ID="dbGovernorate" runat="server" ConnectionString="<%$ ConnectionStrings:ADAMConnectionString %>" SelectCommand="SELECT 0 Id,'---' GovernorateName UNION SELECT Id, GovernorateName FROM GovernorateData WHERE (CityId = @CityId)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlCity" Name="CityId" PropertyName="SelectedValue" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
                <td>
