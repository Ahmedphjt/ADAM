<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webConformPurchaseOrderReport.aspx.cs" Inherits="ADAM.PurchaseReport.webConformPurchaseOrderReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" Text="تقرير طلب الشراء المعتمد" CssClass="lblPageName" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
</asp:Content>
    ...
    <div style="position: relative; padding-right: 50px">
        <table class="table">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPurchaseOrderNo" TextMode="Number" ToolTip="رقم طلب الشراء المعتمد" runat="server" CssClass="txt"></asp:TextBox>
                </td>
                <td></td>
            </tr>
            <tr>
