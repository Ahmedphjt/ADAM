...
{
    public partial class webItemGroupData : System.Web.UI.Page
    {
        public int pageid = 149;
        ...
        protected void btnShowReport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            myReportDocument.Load(Server.MapPath("~/MainReport/Reports/rptItemsGroup.rpt"));
