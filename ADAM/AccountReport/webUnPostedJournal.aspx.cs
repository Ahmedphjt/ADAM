...
{
    public partial class webUnPostedJournal : System.Web.UI.Page
    {
        public int pageid = 144;
        ...
        private void ShowReport(long JournalId)
        {
            ...
            myReportDocument.Load(Server.MapPath("~/AccountReport/Report/rptUnPostedJournal.rpt"));
