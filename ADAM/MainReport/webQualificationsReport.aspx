<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webQualificationsReport.aspx.cs" Inherits="ADAM.MainReport.webQualificationsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
        <h1>
        <asp:Label ID="lblPageName" runat="server" Text="تقرير المؤهلات" CssClass="lblPageName" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
</asp:Content>
