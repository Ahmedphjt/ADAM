...
{
    public partial class webAllPurchaseOrderReport : System.Web.UI.Page
    {
        public int pageid = 44;
        ...
        private void ShowReport()
        {
            try
            {
                ...
                myReportDocument.Load(Server.MapPath("~/PurchaseReport/Report/rptGetAllPurchaseOrder.rpt"));
                ...
                myReportDocument.SetParameterValue("@Status", 0);
                myReportDocument.SetParameterValue("@SStatus", 0);
