<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webrptCashExpense.aspx.cs" Inherits="ADAM.AccountReport.webrptCashExpense" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" Text="تقرير سندات الصرف" CssClass="lblPageName" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
</asp:Content>
    ...
    <div style="position: relative; padding-right: 50px">
        <table class="table">
            <tr>
                ...
                <td></td>
                <td style="text-align: center">
                    <asp:Label ID="Label1" runat="server" Text="رقم سند الصرف" CssClass="lbl"></asp:Label>
                </td>
                <td>
