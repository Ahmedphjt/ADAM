...
{
    public partial class webAuditReport : System.Web.UI.Page
    {
        public int pageid = 69;
        ...
        protected void btnShowReport_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    Response.Write("<script>alert('من فضلك أدخل رقم محضر الاستلام')</script>");
                    return;
                }
        ...
        private void ShowReport()
        {
            try
            {
                ...
                myReportDocument.Load(Server.MapPath("~/StoreReport/Report/rptAudit.rpt"));
