<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webrptRefluxHeaderData.aspx.cs" Inherits="ADAM.StoreReport.webrptRefluxHeaderData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" Text="تقرير طلب الارتجاع" CssClass="lblPageName" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageData" runat="server">
    <div style="position: relative; padding-right: 50px">
        <table>
            ...
            <tr>
                <td style="text-align: center">
                    <asp:Label ID="Label1" runat="server" Text="رقم طلب الارتجاع" CssClass="lbl"></asp:Label>
                </td>
                <td>
