<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webJobsData.aspx.cs" Inherits="ADAM.MainData.webJobsData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" Text="شاشة الوظائف" Font-Size="X-Large" CssClass="lblPageName" Font-Underline="true"></asp:Label></h1>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageData" runat="server">
    <table class="table">
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="كود الوظيفة" CssClass="lbl"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtJobCode" TextMode="Number" ToolTip="ادخل كود الوظيفة ويجب ان يكون رقماً"  runat="server" CssClass="txt"></asp:TextBox></td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="الوظيفة" CssClass="lbl"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtJobName" runat="server" ToolTip="ادخل اسم الوظيفة" CssClass="txt"></asp:TextBox></td>
        </tr>
    </table>
