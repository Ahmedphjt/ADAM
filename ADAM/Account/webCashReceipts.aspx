<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webCashReceipts.aspx.cs" Inherits="ADAM.Account.webCashReceipts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" CssClass="lblPageName" runat="server" Text="شاشة أستلام نقدية" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
    <table class="menu">
        <tr>
            <td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageData" runat="server">
    <div runat="server" id="divData">
        <table class="menu">
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="رقم سند القبض" CssClass="lbl"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDocNo" TextMode="Number" ToolTip="ادخل رقم سند القبض ويجب ان يكون رقماً" runat="server" CssClass="txt"></asp:TextBox>
                </td>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="تاريخ سند القيض" CssClass="lbl"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtDocDate" TextMode="Date" ToolTip="ادخل تاريخ سند القبض" runat="server" CssClass="txt"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="أسم المستلم" CssClass="lbl"></asp:Label>
                </td>
                <td>
