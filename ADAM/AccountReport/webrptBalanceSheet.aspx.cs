...
{
    public partial class webrptBalanceSheet : System.Web.UI.Page
    {
        public int pageid = 146;
        ...
        private void ShowReport()
        {
            ...
            myReportDocument.Load(Server.MapPath("~/AccountReport/Report/rptBalanceSheet.rpt"));
        ...
        protected void btnEdit_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                var DelRows = from a in Db.BalanceSheets select a;
                foreach (ADAM.DataBase.BalanceSheet Deldr in DelRows)
                    Db.BalanceSheets.Remove(Deldr);
                Db.SaveChanges();

                DateTime FromDate = DateTime.Parse(txtFromDate.Text);
                DateTime ToDate = DateTime.Parse(txtToDate.Text);

                var Rows = from a in Db.Accounts where a.ParentId == 0 && (a.MasterCode == 1 || a.MasterCode == 2) select a;
                ...
                if (Rows.Count() > 0)
                {
                    foreach (ADAM.DataBase.Account dr in Rows)
                    {
                        ...
                        ADAM.DataBase.BalanceSheet flevelProf = new DataBase.BalanceSheet();
                        ...
                        else
                        {
                            ...
                            if (SRows.Count() > 0)
                            {
                                foreach (ADAM.DataBase.Account Sdr in SRows)
                                {
                                    ...
                                    ADAM.DataBase.BalanceSheet SlevelProf = new DataBase.BalanceSheet();
                                    ...
                                    if (TRows.Count() > 0)
                                    {
                                        foreach (ADAM.DataBase.Account Tdr in TRows)
                                        {
                                            ...
                                            ADAM.DataBase.BalanceSheet TlevelProf = new DataBase.BalanceSheet();
                                            ...
                                            if (FoRows.Count() > 0)
                                            {
                                                foreach (ADAM.DataBase.Account Fodr in FoRows)
                                                {
                                                    ...
                                                    ADAM.DataBase.BalanceSheet FolevelProf = new DataBase.BalanceSheet();
                                                    ...
                                                    if (FiRows.Count() > 0)
                                                    {
                                                        foreach (ADAM.DataBase.Account Fidr in FiRows)
                                                        {
                                                            ...
                                                            ADAM.DataBase.BalanceSheet FilevelProf = new DataBase.BalanceSheet();
                                                            ...
                                                            if (SiRows.Count() > 0)
                                                            {
                                                                foreach (ADAM.DataBase.Account Sidr in SiRows)
                                                                {
                                                                    ...
                                                                    ADAM.DataBase.BalanceSheet SilevelProf = new DataBase.BalanceSheet();
                                                                    ...
                                                                    if (SeRows.Count() > 0)
                                                                    {
                                                                        foreach (ADAM.DataBase.Account Sedr in SeRows)
                                                                        {
                                                                            ...
                                                                            ADAM.DataBase.BalanceSheet SelevelProf = new DataBase.BalanceSheet();
                                                                            ...
                                                                            if (EiRows.Count() > 0)
                                                                            {
                                                                                foreach (ADAM.DataBase.Account Eidr in EiRows)
                                                                                {
                                                                                    ...
                                                                                    ADAM.DataBase.BalanceSheet EilevelProf = new DataBase.BalanceSheet();
                                                                                    ...
                                                                                    if (NiRows.Count() > 0)
                                                                                    {
                                                                                        foreach (ADAM.DataBase.Account Nidr in NiRows)
                                                                                        {
                                                                                            ...
                                                                                            ADAM.DataBase.BalanceSheet NilevelProf = new DataBase.BalanceSheet();
                                                                                            ...
                                                                                            if (TERows.Count() > 0)
                                                                                            {
                                                                                                foreach (ADAM.DataBase.Account TEdr in TERows)
                                                                                                {
                                                                                                    ...
                                                                                                    ADAM.DataBase.BalanceSheet TElevelProf = new DataBase.BalanceSheet();
                                                                                                    ...
                                                                                                    Db.BalanceSheets.Add(TElevelProf);
                                                                                            ...
                                                                                            Db.BalanceSheets.Add(NilevelProf);
                                                                                    ...
                                                                                    Db.BalanceSheets.Add(EilevelProf);
                                                                            ...
                                                                            Db.BalanceSheets.Add(SelevelProf);
                                                                    ...
                                                                    Db.BalanceSheets.Add(SilevelProf);
                                                            ...
                                                            Db.BalanceSheets.Add(FilevelProf);
                                                    ...
                                                    Db.BalanceSheets.Add(FolevelProf);
                                            ...
                                            Db.BalanceSheets.Add(TlevelProf);
                                    ...
                                    Db.BalanceSheets.Add(SlevelProf);
                        ...
                        Db.BalanceSheets.Add(flevelProf);
                    }
                }
                Db.SaveChanges();
