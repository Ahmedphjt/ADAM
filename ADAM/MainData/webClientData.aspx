<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webClientData.aspx.cs" Inherits="ADAM.MainData.webClientData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" CssClass="lblPageName" Text="شاشة العملاء" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
    <table class="menu">
        <tr>
            <td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="PageData" runat="server">
    <table class="menu">
        <tr>
             <td>
                <asp:Label ID="Label15" runat="server" Text="رقم حساب العميل" CssClass="lbl"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtAccountCode" TextMode="Number" ToolTip="ادخل رقم حساب العميل ويجب ان يكون رقماً" runat="server" CssClass="txt"></asp:TextBox>
            </td>
             <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label14" runat="server" Text="مندوب المبيعات" CssClass="lbl"></asp:Label></td>
            <td>
                <asp:DropDownList ID="ddlSalesRepresentative" CssClass="ddl" runat="server" DataSourceID="dbEmployee" DataTextField="Name" DataValueField="Id" AutoPostBack="True" OnSelectedIndexChanged="ddlSalesRepresentative_SelectedIndexChanged"></asp:DropDownList>
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td colspan="2">
                <asp:SqlDataSource ID="dbEmployee" runat="server" ConnectionString="<%$ ConnectionStrings:ADAMConnectionString %>" SelectCommand="SELECT 0 AS Id, '---' AS Name UNION SELECT Id, FirstName + '  ' + LastName AS Name FROM EmployeeData WHERE (ISSalesRepresentative = 1)"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
    <table>
