<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webDeliveryOrder.aspx.cs" Inherits="ADAM.Prodction.webDeliveryOrder" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" CssClass="lblPageName" runat="server" Text="شاشة انشاء طلب تسليم منتج تام" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
    <br />
    <table class="menu">
        <tr>
            <td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageData" runat="server">
    <table class="menu">
        ...
        <tr>
            ...
            <td style="text-align: center">
                <asp:DropDownList ID="ddlDivision" runat="server" CssClass="ddl" DataSourceID="dbDivision" DataTextField="Name" DataValueField="Id" AutoPostBack="True"></asp:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="ddl" DataSourceID="dbEmployee" DataTextField="Name" DataValueField="Id" AutoPostBack="True"></asp:DropDownList>
            </td>
    ...
    <asp:GridView ID="gvDeliveryData" runat="server" AutoGenerateColumns="False" CssClass="gv" DataSourceID="dbDeliveryData" OnSelectedIndexChanged="gvPurchaseDetailsData_SelectedIndexChanged" DataKeyNames="DeliveryDataDetailsId">
        <Columns>
            ...
            <asp:CommandField ShowSelectButton="True" SelectText="أختيار" />
        </Columns>
    </asp:GridView>
    <br />
    <table class="gv" style="border: solid;">
        ...
        <tr>
            <td style="">
                <asp:TextBox ID="txtItemCode" Width="75px" CssClass="txt" runat="server"> </asp:TextBox><asp:Button ID="btnGetItemData" runat="server" Text="!" OnClick="btnGetItemData_Click" /></td>
            <td style="">
            ...
            <td style="">
                <asp:DropDownList ID="ddlItemColor" CssClass="ddl" runat="server" DataSourceID="dbItemColor" DataTextField="ColorName" DataValueField="Id"></asp:DropDownList>
            </td>
            <td style="">
            ...
            <td style="">
                <asp:TextBox ID="txtTester" Width="100px" CssClass="txt" runat="server"></asp:TextBox></td>
            <td style="">
