<%@ Page Title="" Language="C#" MasterPageFile="~/MyMater.Master" AutoEventWireup="true" CodeBehind="webSupplierReport.aspx.cs" Inherits="ADAM.MainReport.webSupplierReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageAddress" runat="server">
    <h1>
        <asp:Label ID="lblPageName" runat="server" Text="تقرير الموردين" CssClass="lblPageName" Font-Size="X-Large" Font-Underline="true"></asp:Label></h1>
</asp:Content>
    ...
    <div style="position: relative; padding-right: 50px">
        <table class="menu">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCode" TextMode="Number" ToolTip="ادخل كود المورد ويجب ان يكون رقماً" runat="server" CssClass="txt"></asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButton ID="rdoNormalSupplier" runat="server" Text="تقرير عام عن الموردين" Checked="true" ForeColor="White" GroupName="A" /></td>
                <td>
                    <asp:RadioButton ID="rdoSpecSupplier" runat="server" Text="تقرير مفصل عن الموردين" ForeColor="White" GroupName="A" /></td>
