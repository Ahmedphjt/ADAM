...
{
    public partial class webPointOfSaleReport : System.Web.UI.Page
    {
        public int pageid = 33;
        ...
        protected void btnShowReport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            myReportDocument.Load(Server.MapPath("~/MainReport/Reports/rptPointOfSale.rpt"));
